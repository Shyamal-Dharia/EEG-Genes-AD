...
def shuffle_labels_in_loader(data_loader, batch_size):
    ...
    shuffled_loader = DataLoader(shuffled_dataset, batch_size=batch_size, shuffle=True)
...
np.savez(
    'single_run_gradients_and_scores_0vs1.npz',
...
print("\nAll done! Saved results to 'single_run_gradients_and_scores_0vs1.npz'.")
...
# Print results
print(f"\n{'='*40}")
print(f"PERMUTATION TEST RESULTS (0 vs 1)")
print(f"{'='*40}")
...
np.savez(
    'permutation_test_results_0vs1.npz',
...
print(f"\nPermutation test results saved to 'permutation_test_results_0vs1.npz'")
print("All done!")